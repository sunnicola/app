...
public class Coin {
    ...
    public Coin(String id, String symbol, String name, String nameid, Integer rank, String priceUsd, String percentChange24h, String percentChange1h,
                String percentChange7d, String priceBtc, String marketCapUsd, double volume24, double volume24a, String csupply, String tsupply, String msupply) {
        this.id = id;
        this.symbol = symbol;
        this.name = name;
        this.nameid = nameid;
